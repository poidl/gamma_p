...
load('../data/plots_error_3d_gamma_n.mat')
x1=xdf;
y1=dfbar;
...
legend([h1 pp],'location','northwest','\gamma_n','frequency distribution')
%legend([h1 h2 ],'backbone: \gamma_{rf}','backbone: pressure')
print('-dpdf','-r200',['../figures/D_f_3d_global_gamma_n.pdf'])
